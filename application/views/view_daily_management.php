...
<section class="content">
	<div class="box">
		...
		<div class="box-body">
			<div class="header">
				<form class="form-inline" action="daily_management" method="post" align="center">
			...
			<div>
				<table class="table table-bordered table-striped">
					...
					?>
					<br/>
					<a href="<?php echo site_url()."controller_monitoring/print_hourly_daily/$tanggal1/$tanggal2/$tipe/$tanggal"?>">
						<button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print Hourly</button>
					</a>
					<a href="<?php echo site_url()."controller_monitoring/print_summary_daily/$tanggal1/$tanggal2/$tipe/$tanggal"?>">
						<button type="button" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print Summary</button>
					</a>
					<a href="<?php echo site_url()."controller_monitoring/print_detail_daily/$tanggal1/$tanggal2/$tipe/$model/$color/$size/$user"?>">
