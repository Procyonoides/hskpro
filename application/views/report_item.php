			...
			<div class="card">
				...
				<div>
					<table class="table table-bordered table-fixed">
						...
						?>
						<a href="<?php echo site_url()."stock_monitoring/ekspor_hour/$tanggal1/$tanggal2/$tipe/$model/$color/$size/$user/$jam1/$jam2"?>">
						<button type="button" class="btn btn-default pull-right">
                        	<i class="material-icons">print</i>
                        	<span>Print Summary</span>
                    	</button>
                    	</a>
						<a href="<?php echo site_url()."stock_monitoring/ekspor3/$tanggal1/$tanggal2/$tipe/$model/$color/$size/$user/$jam1/$jam2"?>">
                    	<button type="button" class="btn btn-default pull-right">
                        	<i class="material-icons">print</i>
