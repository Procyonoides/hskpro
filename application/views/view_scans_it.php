...
<section class="content">
	<div class="box">
		...
		<div class="box-body">
			<div class="header bg-yellow" style="padding:10px">
				<form method="POST" action="<?php echo site_url('controller_scan/getscanshi_it');?>">	
					<div class="col-lg-12"> 
			...
			<div class="body table-responsive">
				<div class="table-wrapper-scroll-y">                          
					<table class="table table-bordered table-fixed" id="mytable3">
						<thead>
							<tr class="bg-yellow">
								<th>DATE/TIME</th>
			...
			<!-- modal edit shipping -->
			<form id="add-row-form" action="<?php echo base_url().'controller_scan/edit_shi'?>" method="post">
			...
			<form id="add-row-form" action="<?php echo base_url().'controller_scan/delete_shi'?>" method="post">
			...
			<!-- modal move shipping -->
			<form id="add-row-form" action="<?php echo base_url().'controller_monitoring/moves'?>" method="post">
