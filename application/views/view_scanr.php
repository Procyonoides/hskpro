...
<section class="content">
	<div class="box">
		...
		<div class="box-body">
			<div class="header">
				<div class="form-group" align="center">
					<div align="center col-lg-12">
						<button type="button" class="btn btn-success" style="width:400px;height:100px">
					...
					<div align="center col-lg-12">
						<button type="button" class="btn btn-default" style="width:400px;height:70px">
                            <span><strong><p style="font-size:40px">IN</strong></span>
						</button>
					</div></br>
					<div align="center col-lg-12">
			...
			<div class="header bg-green" style="height:70px">
				<form method="POST" action="<?php echo site_url('controller_scan/getscanrec');?>">
					<div class="col-lg-12"> 
			...
			<div class="header bg-green" style="height:90px">
				<div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>				
			</div>
				
			<div class="header bg-green" style="height:110px">
				<div class="col-lg-12">    
					<strong><p style="font-size:70px" align="center"><?php echo $model ?></p></strong>
				</div>						
			</div>
				
			<div class="header bg-green" style="height:80px">
				<div class="col-lg-8">    
			...
			<table class="table table-condensed">
				...
				<tbody>
					<?php foreach($detail_rec as $data){?>
					<tr>
